                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-control-label" for="wonumber">Orden de Compra:</label>
                                <input type="text" class="form-control" id="wonumber" v-model="wo.wonumber" placeholder="" v-validate="'required'" data-vv-as="Orden de Compra" name="wonumber" 
